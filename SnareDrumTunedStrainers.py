...
# Open file
snareDrumTuned = wave.open('/home/luizmunk/Documents/TCC/Codes/Records/SnareDrumTunedStrainer.wav', "r")
...
plt.title('Resposta temporal da caixa afinada com esteiras')
plt.plot(timeSeconds,signalSnareDrumTuned)
plt.xlabel('Time (s)')
plt.ylabel('Sound Amplitude')
plt.grid(True)
plt.draw()
timeResponse.savefig("/home/luizmunk/Documents/TCC/Codes/Graphs/TimeResponseSnareTunedStrainer.pdf", bbox_inches='tight')
...
plt.title('Resposta em frequência da caixa afinada com esteiras')
